...
- [ ] Le fichier de routes `ex11.routes.ts` est créé avec toutes les routes
...
- [ ] `ProductDetailComponent` utilise `input.required<string>()` pour récupérer le paramètre `:id`
