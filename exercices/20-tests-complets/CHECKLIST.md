...
- [ ] Les méthodes `add()`, `toggle()`, `delete()`, `filter()` fonctionnent correctement
...
- [ ] 5 tests de composant passent (affichage, ajout, toggle, suppression, état vide)
- [ ] `fixture.detectChanges()` est appele après chaque action dans les tests de composant
