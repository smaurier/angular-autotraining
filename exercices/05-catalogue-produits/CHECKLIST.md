...
- [ ] L'enfant utilise `output<Product>()` pour emettre l'événement addToCart
...
- [ ] Le bouton "Ajouter au panier" est désactivé si le produit n'est pas en stock
- [ ] Le résumé du panier s'affiche en haut de page
