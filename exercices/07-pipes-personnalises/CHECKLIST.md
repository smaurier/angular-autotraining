...
- [ ] `TimeAgoPipe` est standalone et retourne un texte relatif en français
- [ ] `TimeAgoPipe` géré les cas : instant, minutes, heures, jours, mois
- [ ] `HighlightPipe` est standalone et entoure les occurrences avec `<mark>`
- [ ] `HighlightPipe` est insensible à la casse et echappe les caracteres regex
